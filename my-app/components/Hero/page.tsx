    ...
    <main className="relative min-height-screen bg-white overflow-hidden pt-32 pb-20 px-10">
      ...
      <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
        ...
        <div className="relative mb-4">
          ...
          <div className="absolute -top-2 -right-3 text-[#F17B3C] text-xl">"</div>
        </div>

        {/* Heading */}
        <h1 className="text-7xl text-black font-semibold leading-tight z-10">
        ...
        <div className="relative mt-[-40px] w-full flex justify-center">
          ...
          <div className="absolute bottom-0 w-[600px] h-[300px] bg-[#F9B17A] rounded-t-full -z-0"></div>

          {/* Portrait Image */}
          <div className="relative z-10 w-[500px] h-[600px]">
            <Image 
          ...
          <div className="absolute bottom-10 left-1/2 -translate-x-1/2 z-20 flex items-center bg-white/20 backdrop-blur-md p-2 rounded-full border border-white/30">
...
>
  <button className="text-white font-montserrat px-8 py-4 font-medium">
    Hire Me
          ...
          {/* Sidebar Info: Quote */}
          <div className="absolute left-10 top-1/2 -translate-y-1/2 text-left max-w-[400px] z-20">
...
<div className="flex gap-1 justify-center mb-2">
  {[...Array(5)].map((_, i) => (
    ...
    />
            ...
            <h2 className="text-4xl font-bold">2 Years</h2>
