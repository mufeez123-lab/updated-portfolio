          ...
          <div className="hidden md:flex items-center gap-8">
            {navLinks.map((link) => (
              <Link 
                ...
                className="text-sm font-medium text-gray-300 hover:text-[#70A9FF] transition-all uppercase tracking-widest"
              >
                {link.name}
              </Link>
            ))}
            <Link 
              ...
              className="bg-[#70A9FF] text-black px-6 py-2 rounded-full font-bold text-xs uppercase hover:bg-white transition-all"
            >
              Contact
            </Link>
          </div>
            ...
            <div className={`mt-auto transition-all duration-700 delay-700 ${isOpen ? 'opacity-100' : 'opacity-0'}`}>
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex gap-6">
                  <a href="https://www.linkedin.com/in/mufeez-692840211/" target="_blank" className="text-white hover:text-[#70A9FF] text-sm transition-colors">LinkedIn</a>
                  <a href="https://github.com/mufeez123-lab" target="_blank" className="text-white hover:text-[#70A9FF] text-sm transition-colors">GitHub</a>
                  <a href="mailto:mufizmalar@gmail.com" className="text-white hover:text-[#70A9FF] text-sm transition-colors">Email</a>
                  <a href="https://wa.me/916362514956" target="_blank" className="text-white hover:text-[#70A9FF] text-sm transition-colors">Whatsapp</a>
                </div>
              </div>
            </div>
          </div>
