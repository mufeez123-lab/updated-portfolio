  ...
  return (
    <section id="services" className="relative min-h-screen rounded-[40px] md:rounded-[80px] bg-[#050505] text-white py-16 md:py-24 px-6 md:px-10 overflow-hidden font-sans -mt-10 md:-mt-[80px] shadow-2xl">
      ...
      <div className="absolute inset-0 z-0 opacity-40 pointer-events-none">
        <div className="absolute top-1/4 left-5 md:left-10 w-24 h-24 md:w-32 md:h-32 bg-gradient-to-br from-[#70A9FF] to-transparent rounded-full blur-3xl animate-float" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div data-aos="fade-up" className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 md:mb-20 gap-6">
          <div className="space-y-4">
            ...
            <h2 className="text-4xl md:text-6xl font-bold tracking-tighter">
              My <span className="text-[#70A9FF]">Projects</span>
            </h2>
          </div>

          <p className="max-w-md text-gray-400 text-base md:text-lg font-light leading-relaxed border-l border-[#70A9FF] pl-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          {services.map((service, index) => (
            ...
            >
              <h3 className="text-xl md:text-2xl font-medium tracking-tight group-hover:text-[#70A9FF] transition-colors">
                {service.title}
              </h3>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="bg-white text-black w-10 h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center group-hover:bg-[#70A9FF] group-hover:text-white transition-all duration-500 transform group-hover:rotate-45">
        ...
        <div className="flex items-center justify-center md:justify-start gap-4 mt-12 md:mt-16">
          <div className="h-[2px] w-16 md:w-24 bg-white/10 relative overflow-hidden">
            <div className="absolute inset-0 bg-[#70A9FF] w-1/2 animate-progress" />
          </div>
